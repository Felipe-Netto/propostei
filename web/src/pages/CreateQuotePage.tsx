...
import type { CreateQuoteItemInput } from '@/types/quotes'
...
export function CreateQuotePage() {
  ...
  const canSubmit =
    ...
    title.trim() &&
    items.length > 0 &&
    items.every((i) => i.description.trim() && parseFloat(i.quantity) > 0 && parseFloat(i.unitPrice) >= 0)
    ...
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="q-client" className="font-medium text-slate-700">
              ...
              <select
                ...
                className="h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="q-title" className="font-medium text-slate-700">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="q-desc" className="font-medium text-slate-700">
                Descrição
              </Label>
              <textarea
                id="q-desc"
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="q-valid" className="font-medium text-slate-700">
                Válida até
              </Label>
              <Input
                id="q-valid"
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="flex flex-col gap-2">
            {items.map((item, idx) => {
              const itemTotal = itemTotals[idx] ?? 0
              return (
